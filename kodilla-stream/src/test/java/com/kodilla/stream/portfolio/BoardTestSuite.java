...
public class BoardTestSuite {
    ...
    void testAddTaskListAverageWorkingOnTask() {
        ...
        List<TaskList> listOfTasksInProgress = new ArrayList<>();
        listOfTasksInProgress.add(new TaskList("In progress"));


        double averageTasksDays = project.getTaskLists().stream()
        ...
        assertEquals(10.0, averageTasksDays);
    }
    ...
    private Board prepareTestData() {
        ...
        project.addTaskLists(taskListToDo);
        project.addTaskLists(taskListInProgress);
        project.addTaskLists(taskListDone);
