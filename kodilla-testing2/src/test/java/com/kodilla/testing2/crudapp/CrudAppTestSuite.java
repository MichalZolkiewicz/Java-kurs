...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://michalzolkiewicz.github.io/";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("zolkiewicz.michal@gmail.com");
        driverTrello.findElement(By.id("password")).sendKeys("javakurs1234");
